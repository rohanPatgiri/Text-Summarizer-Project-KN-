...
# line below is additional line (not copy and paste from reaearch Notenook 01)
...
class ConfigurationManager:
    ...
    # returns the following three data mentioned in Step 3
    ...
    # this function will fetch the following 5 variables from the params.yaml file
